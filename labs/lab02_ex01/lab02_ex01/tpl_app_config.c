...
/* Alarm alarmM identifier */
#define alarmM_id 1
CONST(AlarmType, AUTOMATIC) alarmM = alarmM_id;
...
CONST(tpl_task_activation_action, OS_CONST) alarmM_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskM_id
...
CONST(tpl_alarm_static, OS_CONST) alarmM_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , alarmM_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarmM_action
};
...
VAR(tpl_time_obj, OS_VAR) alarmM_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarmM_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  488,
    /* date                         */  488,
...
VAR(uint32_t, OS_VAR) msgM_receive_buffer = 0;
