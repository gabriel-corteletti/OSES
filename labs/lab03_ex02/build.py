...
if True:
  postCommand = makefile.PostCommand("Generating binary lab03_ex02_exe.hex from lab03_ex02_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab03_ex02_exe")
  postCommand.mCommand.append("lab03_ex02_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "lab03_ex02_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab03_ex02_exe on avr/arduino/uno\033[0m")
