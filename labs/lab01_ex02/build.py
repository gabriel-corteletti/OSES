...
if True:
  postCommand = makefile.PostCommand("Generating binary ex02.hex from ex02")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("ex02")
  postCommand.mCommand.append("ex02.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing ex02 on avr/arduino/uno\033[0m")
