...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application RM_scheduler
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab04_ex02.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=../../goil/templates/ lab04_ex02.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab04_ex02/tpl_app_config.c")

sourceList.append("lab04_ex02/tpl_dispatch_table.c")
sourceList.append("lab04_ex02/tpl_invoque.S")
sourceList.append("lab04_ex02/tpl_interrupts.c")
