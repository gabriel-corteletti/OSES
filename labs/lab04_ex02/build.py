...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application RM_scheduler
...
#--- OIL file
oilSourceList.append("lab04_ex02.oil")
...
cSourceList.append(projfile.ProjectFile("lab04_ex02.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab04_ex02/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab04_ex02/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab04_ex02/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab04_ex02/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab04_ex02_exe.hex from lab04_ex02_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab04_ex02_exe")
  postCommand.mCommand.append("lab04_ex02_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "lab04_ex02_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab04_ex02_exe on avr/arduino/uno\033[0m")
