...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application Heartbeat_Monitor
...
cSourceList.append(projfile.ProjectFile("lab05.cpp"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab05_exe.hex from lab05_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab05_exe")
  postCommand.mCommand.append("lab05_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab05_exe on avr/arduino/uno\033[0m")
