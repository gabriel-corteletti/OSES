 ...
 *
 * OS data structure generated from application Heartbeat_Monitor
...
/* Alarm alarmS identifier */
#define alarmS_id 0
CONST(AlarmType, AUTOMATIC) alarmS = alarmS_id;

/*=============================================================================
 * Declaration of receive messages IDs
 */

/* Message msgC_receive identifier */
#define msgC_receive_id 0
CONST(MessageIdentifier, AUTOMATIC) msgC_receive = msgC_receive_id;

/*=============================================================================
 * Declaration of send messages IDs
 */

/* Message msgS_send identifier */
#define msgS_send_id 0
CONST(MessageIdentifier, AUTOMATIC) msgS_send = msgS_send_id;
...
#include "tpl_memmap.h"
tpl_stack_word TaskS_stack_zone[256/sizeof(tpl_stack_word)];
...
#define TaskS_STACK { TaskS_stack_zone, 256 }
...
CONST(tpl_task_activation_action, OS_CONST) alarmS_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) alarmS_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , alarmS_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarmS_action
};
...
VAR(tpl_time_obj, OS_VAR) alarmS_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarmS_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  20,
    /* date                         */  20,
...
/*-----------------------------------------------------------------------------
 * Action of message msgC_receive
 */

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

CONST(tpl_task_activation_action, OS_CONST) msgC_receive_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskC_id
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * ALWAYS filter of message object msgC_receive
 */
#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

tpl_noparam_filter_desc msgC_receive_filter = {
...
/*-----------------------------------------------------------------------------
 * Static internal receiving unqueued message object msgC_receive
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

VAR(int, OS_VAR) msgC_receive_buffer;
...
CONST(tpl_internal_receiving_unqueued_mo, OS_CONST) msgC_receive_message = {
  { /* data receiving mo struct   */
    { /* base receiving mo struct */
      /* notification pointer     */  (tpl_action *)&msgC_receive_action,
    ...
    /*  filter pointer          */  (tpl_filter_desc *)&msgC_receive_filter
  },
  { /* buffer struct    */
    /*  buffer  */  (tpl_com_data *)&msgC_receive_buffer,
    /*  size    */  sizeof(int)
  }
};
...
tpl_receive_message_table[RECEIVE_MESSAGE_COUNT] = {
  (tpl_base_receiving_mo*)&msgC_receive_message
};
...
/*-----------------------------------------------------------------------------
 * Static internal sending static message object msgS_send
 */
CONST(tpl_internal_sending_mo, OS_CONST) msgS_send_message = {
  { /* base message object       */
    /* sending function          */ tpl_send_static_internal_message
  },
  /* pointer to the receiving mo */ (tpl_base_receiving_mo *)&msgC_receive_message
};
...
tpl_send_message_table[SEND_MESSAGE_COUNT] = {
  (tpl_base_sending_mo*)&msgS_send_message
};
